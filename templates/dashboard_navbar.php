...
<nav class="pl-1 pr-0 navbar navbar-expand-md navbar-dark fixed-top bg-dark">
	...
	<div class="collapse navbar-collapse" id="navbarsExampleDefault">
		<ul class="navbar-nav mr-auto">
			<li class="nav-item">
				<a class="nav-link text-light lead pl-1 ml-0" href="/index.php" style="font-family: 'Alegreya Sans SC', 'Alegreya Sans', Verdana, Tahoma, sans-serif; font-weight: normal; font-size: 23px;">Home <span class="sr-only">(Fee management system)</span></a>
			</li>
		</ul>
