...
if (isset($_SESSION['userid']) && ($_SESSION['userstatus'] == 'ACCOUNTS')) {
    ...
    ?>
            <span style="font-family: 'Alegreya Sans', Verdana, Tahoma, sans-serif; font-size: 22px;"><i class="fa fa-exclamation-circle" aria-hidden="true" style="color: #2c9676;"></i> Invoice(s) alreday generated for class <?php echo $className; ?> till <?php echo $lastDate; ?>.</span>
        <?php } ?> 
